package com.shura.mall.model.oms;
...
public class OmsOrderItem implements Serializable {
    ...
    @ApiModelProperty(value = "商品 sku 条码")
    private String productSkuCode;

    @ApiModelProperty(value = "商品分类 id")
    private Long productCategoryId;

    @ApiModelProperty(value = "商品的销售属性 1")
    private String sp1;

    @ApiModelProperty(value = "商品的销售属性 2")
    private String sp2;

    @ApiModelProperty(value = "商品的销售属性 3")
    private String sp3;
